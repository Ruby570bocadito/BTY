#!/usr/bin/env python3
"""
BTY C2 — Lateral Movement Module
...
def find_agent_binary():
    ...
    candidates = [
        project_root / "bty-agent",
        project_root / "bty-agent.exe",
        project_root / "dist" / "bty-agent-linux",
    ]
    for c in candidates:
        if c.exists():
            return str(c)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="BTY Lateral Movement")
