#!/usr/bin/env python3
"""
BTY C2 — Document Injection & LOLBins Generator
...
def main():
    parser = argparse.ArgumentParser(description="BTY Document Injection & LOLBins")
    ...
    print(f"{BOLD}{CYAN}BTY Document Injection & LOLBins Generator{RESET}")
