#!/usr/bin/env python3
"""
BTY C2 - TLS Certificate Generator
...
def generate_certs(output_dir, domain, days, key_size):
    ...
    print(f"{BOLD}{CYAN}BTY C2 - TLS Certificate Generator{RESET}\n")
    ...
    cmd = (
        ...
        f"-out {cert_file} "
        f"-days {days} "
        f"-subj '/CN={domain}/O=BTY C2/C=US' "
...
def main():
    p = argparse.ArgumentParser(description="BTY C2 TLS Certificate Generator")
