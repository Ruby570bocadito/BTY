...
def get_agent_binary():
    ...
    linux = PROJECT_ROOT / "bty-agent"
    windows = PROJECT_ROOT / "bty-agent.exe"
    darwin_amd = PROJECT_ROOT / "dist" / "bty-agent-darwin-amd64"
    darwin_arm = PROJECT_ROOT / "dist" / "bty-agent-darwin-arm64"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="BTY Mass Deployment")
